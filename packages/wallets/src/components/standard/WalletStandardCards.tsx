...
export default function WalletStandardCards(props: Props) {
  ...
  return (
    <WalletCards
      ...
      totalBalanceTooltip={
        <Trans>
          This is the total amount of cactus in the blockchain at the current peak
      ...
      spendableBalanceTooltip={
        <Trans>
          This is the amount of Cactus that you can currently use to make
          transactions. It does not include pending farming rewards, pending
          incoming transactions, and Cactus that you have just spent but is not
