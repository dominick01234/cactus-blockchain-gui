...
import { CardStep, ConfirmDialog, Link, Select, StateColor, useOpenDialog } from '@cactus/core';
import {
  Grid,
  FormControl,
  Typography,
    ...
    <CardStep step={step} title={<Trans>Choose Plot Size</Trans>}>
      <Typography variant="subtitle1">
        <Trans>
          ...
          <Link
            target="_blank"
            href="https://github.com/Cactus-Network/cactus-blockchain/wiki/k-sizes"
          >
            Learn more
          </Link>
        </Trans>
